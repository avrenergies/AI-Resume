...
def find_address_block(text):
    ...
    print("BLOCK LINES =", block)
    block_text = ", ".join(block)
    print("RAW BLOCK TEXT =", block_text)
    ...
    for stop in STOP_WORDS:
       if re.search(stop, block_text, flags=re.I):
           print("MATCHED STOP WORD =", stop)
...
def extract_address(text):
    ...
    print("LOCATION_ADDRESS CALLED")

    address_block = find_address_block(text)
    print("ADDRESS BLOCK =", address_block)
